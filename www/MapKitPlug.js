(function(window) {
    ...
    var MapKit = function() {
        this.options = {
            ...
            dragCallback: 'window.plugins.mapKit.onPinDragCallback',
            height: 460,
            diameter: 1000,
            atBottom: true,
            lat: 49.281468,
    ...
    MapKit.prototype = {
        ...
        showMap: function() {
            cordovaRef.exec(null, null,  'MapKitView', 'showMap', []);
        },
        ...
        setMapData: function(options) {
            ...
            cordovaRef.exec(null, null, 'MapKitView', 'setMapData', [this.options]);
        },
        ...
        addMapPins: function(pins) {
            ...
            cordovaRef.exec(null, null, 'MapKitView', 'addMapPins', [pinStr]);
        },

        zoomToFitMapAnnotations: function(){
            cordovaRef.exec(null, null, 'MapKitView', 'zoomToFitMapAnnotations', []);
        },

        clearMapPins: function() {
            cordovaRef.exec(null, null, 'MapKitView', 'clearMapPins', []);
        },
        ...
        zoomToPins: function(){
            cordovaRef.exec(null, null, 'MapKitView', 'zoomToPins', []);
        }
